...
var createSaga = _interopDefault(require('redux-saga'));
...
var useUndo = _interopDefault(require('use-undo'));
...
var _createActions = reduxsauce.createActions({
...
var reducer = reduxsauce.createReducer(INITIAL_STATE, HANDLERS);
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return effects.put(loadingOptions$1(true));

        case 4:
          option = payload.option;
          _context.next = 7;
          return effects.call(api.get, "/stocks/options/expirations/" + option);
        ...
        case 7:
          ...
          _context.next = 12;
          return effects.put(setFieldValues$1({
            field: "calls",
            values: []
          }));
        ...
        case 22:
          return _context.abrupt("return", reactToastify.toast.warn("Não há dados disponíveis para este ativo."));
        ...
        case 38:
          _context.next = 40;
          return effects.put(loadPagination$1());
        ...
        case 42:
          ...
          reactToastify.toast.error(SERVER_ERROR);

        case 45:
          _context.prev = 45;
          _context.next = 48;
          return effects.put(loadingOptions$1(false));
  ...
  return regeneratorRuntime.wrap(function rootSaga$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return effects.all([effects.takeLatest(Types.LOAD_OPTIONS, loadOptions), effects.takeEvery(Types.LOAD_REACTIVE_OPTIONS, loadReactiveOptions)]);
...
if (process.env.NODE_ENV === "development") {
  middlewares = reduxDevtoolsExtension.composeWithDevTools(redux.applyMiddleware(sagaMiddleware));
} else {
  middlewares = redux.applyMiddleware(sagaMiddleware);
}

var store = redux.createStore(reducers, middlewares);
...
var ComponentWrapper = function ComponentWrapper(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(reactRedux.Provider, {
    store: store
  }, children, /*#__PURE__*/React__default.createElement(reactToastify.ToastContainer, null), /*#__PURE__*/React__default.createElement(GlobalStyle, null));
};
...
var Wrapper = styled__default.nav(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteralLoose(["\n  position: relative;\n  width: 100%;\n  height: 60px;\n  display: flex;\n  justify-content: space-between;\n  background-color: ", ";\n\n  ::before {\n    content: \"\";\n    position: absolute;\n    z-index: 9;\n    top: 0;\n    height: 50%;\n    width: 100%;\n    background-color: rgba(255, 255, 255, 0.13);\n    filter: blur(3px);\n  }\n\n  .search {\n    margin: 10px 0 0 10px;\n    position: relative;\n    z-index: 99;\n  }\n\n  .items {\n    display: grid;\n    grid-template-columns: 2.5fr repeat(5, 1.8fr) 6fr;\n    position: relative;\n    top: 5px;\n  }\n"])), color.primary);
var Item = styled__default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteralLoose(["\n  margin: 0 40px;\n  position: relative;\n\n  h1 {\n    margin: 0;\n    font-size: 9pt;\n    color: ", ";\n    font-family: ", ";\n    line-height: 15pt;\n  }\n\n  p {\n    margin: 0;\n    font-size: 16pt;\n    color: ", ";\n    font-family: ", ";\n    line-height: 26pt;\n  }\n\n  .loading {\n    position: absolute;\n    top: 10px;\n\n    svg {\n      height: 50px;\n    }\n  }\n"])), color.text, font.family.primary, function (props) {
  return props.red ? "red" : color.textLight;
}, font.family.primary);
var CorporationName = styled__default.h1(_templateObject3 || (_templateObject3 = _taggedTemplateLiteralLoose(["\n  position: relative;\n  font-size: 16pt;\n  color: ", ";\n  text-transform: uppercase;\n  font-family: ", ";\n  line-height: 26pt;\n\n  .loading {\n    position: absolute;\n    top: 10px;\n    right: 60px;\n\n    svg {\n      height: 50px;\n    }\n  }\n"])), color.textLight, font.family.primary);
var Buttons = styled__default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteralLoose(["\n  margin: 5px 10px 0 0;\n  display: flex;\n  position: relative;\n  z-index: 99;\n\n  .button {\n    cursor: pointer;\n    /* :hover {\n      .cls-1 {\n        fill: ", ";\n        stroke: ", ";\n      }\n    } */\n  }\n\n  svg {\n    width: 40px;\n    margin: 0 5px;\n\n    .cls-1 {\n      fill: transparent;\n    }\n  }\n"])), color.button, color.button);

var _templateObject$2;
var Center = styled__default.div(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteralLoose(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n"])));
...
var Wrapper$1 = styled__default.div(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteralLoose(["\n  display: flex;\n"])));
var Input = styled__default.input(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteralLoose(["\n  text-transform: uppercase;\n  background-color: black;\n  border: 2pt solid ", ";\n  border-radius: 5px 0 0 5px;\n  color: ", ";\n  text-align: center;\n  font-size: 12pt;\n  font-family: myriad-pro, sans-serif;\n  line-height: 20pt;\n"])), color.primaryLight, color.text);
var Button = styled__default.div(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteralLoose(["\n  cursor: pointer;\n  width: 40px;\n  height: 40px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: ", ";\n  border-radius: 0 5px 5px 0;\n  :hover {\n    opacity: 0.8;\n  }\n  svg {\n    width: 20px;\n  }\n"])), color.primaryLight);
...
var Icon = styled__default.div(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteralLoose(["\n  width: ", ";\n  height: ", ";\n\n  background-color: ", ";\n  mask: url(", ") no-repeat center / contain;\n  -webkit-mask: url(", ") no-repeat center / contain;\n"])), function (props) {
...
var Wrapper$2 = styled__default.div(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteralLoose(["\n  display: grid;\n  grid-template-columns: 1.6fr 1fr;\n  margin: 5px 0;\n  color: white;\n"])));
var Options = styled__default.div(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteralLoose(["\n  display: grid;\n  grid-template-rows: 1fr 1fr;\n  grid-row-gap: 20px;\n"])));
var Main = styled__default.div(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteralLoose(["\n  margin-top: -70px;\n  display: flex;\n  grid-template-columns: 3fr 1fr 3fr;\n  grid-column-gap: 10px;\n"])));
var Move = styled__default.span(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteralLoose(["\n  display: ", ";\n  cursor: ", ";\n  opacity: ", ";\n  position: relative;\n  width: 100%;\n  height: 40px;\n  background-color: ", ";\n\n  .totalItems {\n    position: absolute;\n    left: 10px;\n    bottom: 5px;\n  }\n\n  .countItems {\n    position: absolute;\n    right: 10px;\n    bottom: 5px;\n  }\n\n  :hover {\n    opacity: ", ";\n  }\n  ::before {\n    content: \"\";\n    color: black;\n    position: relative;\n    top: 10px;\n    left: calc(50% - 10px);\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    width: 0;\n    height: 0;\n  }\n"])), function (props) {
...
var MoveUp = styled__default(Move)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteralLoose(["\n  margin-top: -15px;\n  ::before {\n    border-left: 20px solid transparent;\n    border-right: 20px solid transparent;\n    border-bottom: 20px solid #050000;\n  }\n"])));
var MoveDown = styled__default(Move)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteralLoose(["\n  margin-top: -10px;\n  ::before {\n    border-top: 20px solid #050000;\n    border-right: 20px solid transparent;\n    border-left: 20px solid transparent;\n  }\n"])));
...
var _ref$3 = /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("style", null, ".arrow_svg__cls-1{fill:#d2d5d2}"));
...
var TableHeader = styled__default.div(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteralLoose(["\n  background-color: ", ";\n  display: flex;\n  align-items: center;\n  justify-content: ", ";\n  height: 40px;\n"])), color.primary, function (props) {
  return props.right && "flex-end";
});
var TableHeaderDate = styled__default.h1(_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteralLoose(["\n  color: ", ";\n  font-size: 12pt;\n  line-height: 14pt;\n  font-family: ", ";\n  padding-left: 40px;\n  padding-right: ", ";\n  display: flex;\n\n  span {\n    cursor: pointer;\n    border: solid ", ";\n    border-width: 0 4px 4px 0;\n    display: inline-block;\n    position: relative;\n    padding: 7px;\n    transform: ", ";\n    top: ", ";\n    margin-right: ", ";\n    margin-left: ", ";\n\n    :hover {\n      opacity: 0.8;\n    }\n  }\n"])), color.text, font.family.primary, function (props) {
...
var TableHeaderTitle = styled__default(TableHeaderDate)(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteralLoose(["\n  text-transform: uppercase;\n"])));
var TableContent = styled__default.div(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteralLoose(["\n  .header {\n    display: grid;\n    align-content: center;\n    grid-template-columns: ", ";\n    padding: 0 10px;\n    margin-top: 5px;\n    background-color: ", ";\n    height: 40px;\n\n    h1 {\n      color: ", ";\n      font-size: 12pt;\n      line-height: 14pt;\n      font-family: ", ";\n      text-transform: uppercase;\n\n      :nth-child(1) {\n        margin-left: ", ";\n      }\n\n      :nth-child(n + 2) {\n        ::before {\n          content: \"\";\n          position: relative;\n          margin-right: 5px;\n          border-right: 1px dashed ", ";\n        }\n      }\n    }\n  }\n"])), function (props) {
  return "repeat(" + props.cols + ", 1fr)";
}, color.primary, color.text, font.family.primary, function (props) {
  return props.cols > 5 && "40px";
}, color.text);
var TableContentHeader = styled__default.div(_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteralLoose(["\n  display: grid;\n  align-content: center;\n  grid-template-columns: ", ";\n  padding: 0 10px;\n  margin-top: 5px;\n  background-color: ", ";\n  height: 40px;\n\n  h1 {\n    color: ", ";\n    font-size: 12pt;\n    line-height: 14pt;\n    font-family: ", ";\n    text-transform: uppercase;\n\n    :nth-child(1) {\n      margin-left: ", ";\n    }\n\n    :nth-child(n + 2) {\n      ::before {\n        content: \"\";\n        position: relative;\n        margin-right: 5px;\n        border-right: 1px dashed ", ";\n      }\n    }\n  }\n"])), function (props) {
  return "repeat(" + props.cols + ", 1fr)";
}, color.primary, color.text, font.family.primary, function (props) {
  return props.cols > 5 && "40px";
}, color.text);
var TableContentRow = styled__default.div(_templateObject6$1 || (_templateObject6$1 = _taggedTemplateLiteralLoose(["\n  display: grid;\n  grid-template-columns: ", ";\n  padding: 0 0 5px 0;\n  border-bottom: 1px dashed ", ";\n  color: ", ";\n  font-size: 12pt;\n  line-height: 23pt;\n  font-family: ", ";\n  max-height: 22px;\n\n  p {\n    position: relative;\n    bottom: 3px;\n    color: ", ";\n\n    :nth-child(1) {\n      margin-left: ", ";\n    }\n\n    :nth-child(n + 2) {\n      margin-left: 15px;\n    }\n  }\n\n  .M {\n    text-transform: uppercase;\n  }\n\n  .value {\n    color: green;\n  }\n"])), function (props) {
  return "repeat(" + props.cols + ", 1fr)";
...
var Wrapper$3 = styled__default.header(_templateObject$7 || (_templateObject$7 = _taggedTemplateLiteralLoose(["\n  display: grid;\n  grid-template-columns: 3fr 1fr 3fr;\n  grid-column-gap: 10px;\n"])));
var StrikeTableHeader = styled__default.div(_templateObject2$4 || (_templateObject2$4 = _taggedTemplateLiteralLoose(["\n  background-color: ", ";\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 40px;\n  h1 {\n    color: ", ";\n    font-size: 12pt;\n    line-height: 14pt;\n    text-transform: uppercase;\n    font-family: ", ";\n  }\n  svg {\n    cursor: pointer;\n    height: 15px;\n    margin-left: 5px;\n    transition: transform 0.2s;\n    transform: ", ";\n    :hover {\n      opacity: 0.8;\n    }\n  }\n"])), color.primary, color.text, font.family.primary, function (props) {
  return props.rotate ? "rotate(180deg)" : "rotate(0deg)";
});
var StrikeTableContentHeader = styled__default.div(_templateObject3$4 || (_templateObject3$4 = _taggedTemplateLiteralLoose(["\n  display: grid;\n  grid-template-columns: ", ";\n  height: 40px;\n  margin-top: 5px;\n  background-color: ", ";\n\n  h1 {\n    position: relative;\n    top: 5px;\n    margin: 10px;\n    color: ", ";\n    font-size: 12pt;\n    line-height: 14pt;\n    font-family: ", ";\n\n    :nth-child(2) {\n      top: -5px;\n    }\n\n    :nth-child(even) {\n      text-transform: uppercase;\n    }\n  }\n"])), function (props) {
  return "repeat(" + props.cols + ", 1fr)";
...
var Wrapper$4 = styled__default.div(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteralLoose([""])));
var TableContentRow$1 = styled__default(TableContentRow)(_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteralLoose(["\n  position: relative;\n\n  .value {\n    position: relative;\n    z-index: 9999;\n    cursor: pointer;\n  }\n"])));
var RowSelected = styled__default.div(_templateObject3$5 || (_templateObject3$5 = _taggedTemplateLiteralLoose(["\n  ", "\n\n  ", "\n\n  border-radius: 5px;\n  position: absolute;\n  width: calc(100% + 115px);\n  height: 20px;\n  top: 3px;\n  left: 20px;\n\n  .type {\n    position: absolute;\n    /* left: -10px; */\n    height: 100%;\n    width: 20px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n\n  .remove {\n    position: absolute;\n    z-index: 999;\n    right: 0;\n    height: 100%;\n    width: 20px;\n    display: ", ";\n    justify-content: center;\n    align-items: center;\n  }\n"])), function (props) {
  return props.active === "sell" && styled.css(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteralLoose(["\n      border: 1px solid red;\n\n      .remove,\n      .type {\n        cursor: pointer;\n        background-color: red;\n      }\n    "])));
}, function (props) {
  return props.active === "buy" && styled.css(_templateObject5$2 || (_templateObject5$2 = _taggedTemplateLiteralLoose(["\n      border: 1px solid green;\n\n      .remove,\n      .type {\n        cursor: pointer;\n        background-color: green;\n      }\n    "])));
}, function (props) {
  var _props$active;
...
var _ref$4 = /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("style", null, ".horizontal-lines_svg__cls-1{fill:#7d7d7d}"));
...
var Wrapper$5 = styled__default.div(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteralLoose(["\n  width: 180px;\n"])));
var TableContent$1 = styled__default.div(_templateObject2$6 || (_templateObject2$6 = _taggedTemplateLiteralLoose([""])));
var TableContentRow$2 = styled__default.div(_templateObject3$6 || (_templateObject3$6 = _taggedTemplateLiteralLoose(["\n  display: grid;\n  grid-template-columns: ", ";\n  padding: 0 0 5px 0;\n  border-bottom: 1px dashed ", ";\n  color: ", ";\n  font-size: 10pt;\n  font-family: ", ";\n  max-height: 22px;\n\n  p {\n    position: relative;\n    z-index: 999;\n  }\n\n  svg {\n    width: 20px;\n    position: relative;\n    top: -36px;\n    left: 265%;\n  }\n\n  :nth-child(odd) {\n    background-color: ", ";\n  }\n\n  :nth-child(", ") {\n    ::after {\n      content: \"\";\n      position: relative;\n      border-top: 1px solid red;\n      border-right: 1px solid red;\n      border-bottom: 1px solid red;\n      border-radius: 0 5px 5px 0;\n    }\n  }\n\n  :nth-child(", ") {\n    ::after {\n      content: \"\";\n      position: relative;\n      left: 100%;\n      border-top: 1px solid green;\n      border-bottom: 1px solid green;\n      border-left: 1px solid green;\n      border-radius: 5px 0 0 5px;\n    }\n  }\n\n  ::after {\n    content: \"\";\n    top: -34px;\n    position: relative;\n    z-index: 99;\n    height: 22px;\n    width: calc(100% * 2);\n  }\n\n  p {\n    position: relative;\n    bottom: 5px;\n    margin: 10px;\n    color: ", ";\n    font-size: 12pt;\n    line-height: 14pt;\n    font-family: ", ";\n    text-transform: uppercase;\n  }\n\n  .code {\n    font-size: 10pt;\n  }\n"])), function (props) {
  return "repeat(" + props.cols + ", 1fr)";
...
var Wrapper$6 = styled__default.div(_templateObject$a || (_templateObject$a = _taggedTemplateLiteralLoose([""])));
var TableContentRow$3 = styled__default(TableContentRow)(_templateObject2$7 || (_templateObject2$7 = _taggedTemplateLiteralLoose(["\n  position: relative;\n\n  p {\n    position: relative;\n    right: 5px;\n\n    :nth-child(1) {\n      margin-left: 10px;\n    }\n  }\n\n  .value {\n    position: relative;\n    z-index: 9999;\n    cursor: pointer;\n  }\n"])));
var RowSelected$1 = styled__default.div(_templateObject3$7 || (_templateObject3$7 = _taggedTemplateLiteralLoose(["\n  ", "\n\n  ", "\n\n  border-radius: 5px;\n  position: absolute;\n  width: calc(100% + 130px);\n  height: 20px;\n  top: 3px;\n  right: 10px;\n\n  .type {\n    position: absolute;\n    right: 0;\n    height: 100%;\n    width: 20px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n\n  .remove {\n    position: absolute;\n    z-index: 999;\n    left: 0;\n    height: 100%;\n    width: 20px;\n    display: ", ";\n    justify-content: center;\n    align-items: center;\n  }\n"])), function (props) {
  return props.active === "sell" && styled.css(_templateObject4$4 || (_templateObject4$4 = _taggedTemplateLiteralLoose(["\n      border: 1px solid red;\n\n      .remove,\n      .type {\n        cursor: pointer;\n        background-color: red;\n      }\n    "])));
}, function (props) {
  return props.active === "buy" && styled.css(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteralLoose(["\n      border: 1px solid green;\n\n      .remove,\n      .type {\n        cursor: pointer;\n        background-color: green;\n      }\n    "])));
}, function (props) {
  var _props$active;
...
var _ref$7 = /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("style", null, ".more-or-less_svg__cls-1{fill:#717172}"));
...
var _ref$8 = /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("style", null, ".horizontal-arrows_svg__cls-1{fill:#717172}"));
...
var _ref$9 = /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("style", null, ".bell_svg__cls-1,.bell_svg__cls-2{fill:#fff}.bell_svg__cls-2{stroke:#007bff;stroke-miterlimit:10}"));
...
var Wrapper$7 = styled__default.div(_templateObject$b || (_templateObject$b = _taggedTemplateLiteralLoose(["\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  margin: 0 5px;\n\n  svg {\n    width: 24px;\n  }\n\n  button {\n    cursor: pointer;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    padding: 5px 10px;\n    background-color: ", ";\n    border-radius: 5px;\n    border: none;\n    font-family: ", ";\n    font-size: ", ";\n    color: ", ";\n\n    ", "\n  }\n"])), color.button, font.family.primary, font.size.normal, color.textLight, effect.hover);
var Header$1 = styled__default.div(_templateObject2$8 || (_templateObject2$8 = _taggedTemplateLiteralLoose(["\n  display: flex;\n  height: 40px;\n\n  .body {\n    background-color: ", ";\n    width: 100%;\n    margin-right: 6px;\n  }\n\n  .strategy {\n    background-color: ", ";\n    padding: 10px;\n    display: flex;\n  }\n\n  .search {\n    cursor: pointer;\n    background-color: ", ";\n    padding: 10px;\n    border: 1px solid ", ";\n    border-radius: 0 5px 5px 0;\n\n    ", "\n\n    svg {\n      path {\n        fill: ", ";\n        width: 24px;\n      }\n    }\n  }\n  transition: 1s;\n  .searchInput {\n    display: ", ";\n    position: absolute;\n    z-index: 999;\n    top: 50px;\n    right: 0;\n  }\n"])), color.primary, color.tableCell, color.primary, color.primaryLight, effect.hover, color.primaryLight, function (props) {
  return !props.isSearchOpen && "none";
});
var Actions = styled__default.div(_templateObject3$8 || (_templateObject3$8 = _taggedTemplateLiteralLoose(["\n  margin: 5px 0;\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  grid-column-gap: 5px;\n\n  button {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    border-radius: 0;\n    cursor: pointer;\n    height: 40px;\n    background-color: ", ";\n\n    svg {\n      width: 15px;\n\n      .cls-1 {\n        fill: ", ";\n      }\n    }\n    h2 {\n      margin-right: 5px;\n    }\n\n    ", "\n\n    :disabled {\n      cursor: default;\n      opacity: 0.6;\n    }\n  }\n"])), color.tableCell, color.text, effect.hover);
var Options$1 = styled__default.div(_templateObject4$5 || (_templateObject4$5 = _taggedTemplateLiteralLoose(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 0 10px;\n  background-color: ", ";\n  height: 60px;\n\n  .button {\n    cursor: pointer;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    ", "\n\n    svg {\n      width: 40px;\n      height: 20px;\n      margin-top: 10px;\n\n      .cls-1 {\n        fill: ", ";\n      }\n    }\n  }\n"])), color.primary, effect.hover, color.text);
var Table = styled__default.div(_templateObject5$4 || (_templateObject5$4 = _taggedTemplateLiteralLoose([""])));
var TableHeader$1 = styled__default.div(_templateObject6$2 || (_templateObject6$2 = _taggedTemplateLiteralLoose(["\n  background-color: ", ";\n  height: 30px;\n  display: grid;\n  grid-template-columns: 3fr 2fr 4fr repeat(3, 3fr);\n  align-items: center;\n  padding: 0 10px;\n\n  h3 {\n    font-weight: normal;\n    text-transform: uppercase;\n  }\n"])), color.tableCell);
var TableContent$2 = styled__default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteralLoose(["\n  background-color: ", ";\n  padding: 5px 0;\n"])), color.primary);
var TableRow = styled__default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteralLoose(["\n  display: grid;\n  grid-template-columns: 2.5fr 2fr 4fr repeat(3, 3fr);\n  padding: 0 10px;\n\n  p {\n    font-size: ", ";\n    padding: 0;\n    margin: 0;\n  }\n\n  .cod,\n  .qtde,\n  .vcto,\n  .strike {\n    display: grid;\n    justify-items: center;\n    padding: 5px;\n    margin: 2.5px 0;\n    border-radius: 5px;\n    background-color: rgba(255, 255, 255, 0.18);\n  }\n\n  .qtde,\n  .vcto,\n  .strike {\n    margin: 5px;\n\n    p {\n      color: ", ";\n    }\n  }\n\n  .cod {\n    margin: 5px 5px 0 0;\n    height: 16px;\n    p {\n      color: ", ";\n    }\n  }\n\n  .cv {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n\n    .buy,\n    .sell {\n      display: grid;\n      justify-items: center;\n      width: 15px;\n      background-color: rgba(255, 255, 255, 0.18);\n      padding: 5px;\n      margin: 0 5px;\n      border-radius: 8px;\n\n      p {\n        opacity: 0.4;\n      }\n    }\n\n    .buy {\n      background-color: ", ";\n\n      p {\n        color: white;\n        font-weight: bold;\n        opacity: ", ";\n      }\n    }\n\n    .sell {\n      background-color: ", ";\n\n      p {\n        color: white;\n        font-weight: bold;\n        opacity: ", ";\n      }\n    }\n  }\n\n  .qtde,\n  .vcto,\n  .strike {\n    position: relative;\n\n    p {\n      margin-right: 15px;\n    }\n    .buttons {\n      position: absolute;\n      top: calc(8%);\n      right: 5px;\n\n      .up {\n        cursor: pointer;\n        margin-bottom: 4px;\n        width: 0;\n        height: 0;\n        border-style: solid;\n        border-width: 0 5px 9px 5px;\n        border-color: transparent transparent ", " transparent;\n\n        ", "\n      }\n\n      .down {\n        cursor: pointer;\n        width: 0;\n        height: 0;\n        border-style: solid;\n        border-width: 9px 5px 0 5px;\n        border-color: ", " transparent transparent transparent;\n\n        ", "\n      }\n    }\n  }\n\n  .family {\n    margin-left: 10px;\n    /* display: flex;\n      align-items: center;\n      justify-content: space-between; */\n    display: grid;\n    grid-template-columns: 1.5fr 1fr 1fr;\n    justify-items: center;\n    align-items: center;\n\n    p {\n      text-transform: uppercase;\n      margin-bottom: 0;\n    }\n\n    img {\n      width: 40px;\n    }\n\n    .close {\n      cursor: pointer;\n\n      ", ";\n    }\n  }\n"])), font.size.normal, color.strategyTable, color.text, function (props) {
...
var Slider = styled__default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteralLoose(["\n  background-color: ", ";\n  height: 60px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  .slide {\n    width: 60%;\n\n    .title,\n    .values {\n      display: flex;\n      justify-content: space-between;\n    }\n\n    .content {\n      position: relative;\n      background-color: ", ";\n      height: 10px;\n\n      .control {\n        position: absolute;\n        background-color: red;\n        height: 100%;\n        width: 5px;\n        left: 60%;\n      }\n    }\n  }\n"])), color.tableCell, color.sliderBar);
var Alert = styled__default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteralLoose(["\n  background-color: ", ";\n  padding: 5px;\n  display: grid;\n  grid-template-columns: 2fr 1fr;\n\n  .row {\n    display: flex;\n    align-items: center;\n    padding-left: 50px;\n\n    p {\n      color: ", ";\n      width: 100px;\n    }\n  }\n\n  .amount {\n    position: relative;\n    display: grid;\n    justify-items: center;\n    padding: 5px;\n    margin: 2.5px 0;\n    border-radius: 5px;\n    background-color: rgba(255, 255, 255, 0.18);\n\n    p {\n      color: ", ";\n      margin-right: 25px;\n    }\n\n    .buttons {\n      position: absolute;\n      top: calc(10%);\n      right: 5px;\n\n      .up {\n        cursor: pointer;\n        margin-bottom: 4px;\n        width: 0;\n        height: 0;\n        border-style: solid;\n        border-width: 0 6px 10px 6px;\n        border-color: transparent transparent ", " transparent;\n\n        ", "\n      }\n\n      .down {\n        cursor: pointer;\n        width: 0;\n        height: 0;\n        border-style: solid;\n        border-width: 10px 6px 0 6px;\n        border-color: ", " transparent transparent transparent;\n\n        ", "\n      }\n    }\n  }\n\n  .value {\n    display: flex;\n    margin: 0 10px 15px auto;\n    p {\n      margin: 0 5px;\n    }\n  }\n\n  .button {\n    display: flex;\n\n    .alert {\n      cursor: pointer;\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      padding: 5px;\n      background-color: ", ";\n      border-radius: 5px;\n\n      ", "\n\n      span {\n        background-color: white;\n        width: 1px;\n        height: calc(100% + 10px);\n      }\n      p {\n        margin-right: 5px;\n      }\n\n      svg {\n        width: 20px;\n        margin: 0 5px;\n      }\n    }\n  }\n\n  .row-2 {\n    display: flex;\n  }\n\n  img {\n    cursor: pointer;\n    width: 25px;\n    margin-left: 10px;\n\n    svg {\n      .cls-1 {\n        fill: red;\n      }\n    }\n\n    ", "\n  }\n"])), color.primary, color.text, color.strategyTable, color.text, effect.hover, color.text, effect.hover, color.button, effect.hover, effect.hover);
var Signature = styled__default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteralLoose(["\n  background-color: ", ";\n  padding: 5px 20px 20px 50px;\n  display: flex;\n  justify-content: space-between;\n\n  section {\n    label {\n      color: ", ";\n    }\n\n    :nth-child(2) {\n      display: flex;\n      align-items: center;\n      margin-top: auto;\n    }\n  }\n\n  .input {\n    display: flex;\n    flex-direction: column;\n    margin-bottom: 10px;\n\n    input {\n      border: none;\n      background-color: ", ";\n      color: ", ";\n      height: 30px;\n      width: 150px;\n      border-radius: 5px;\n      padding: 0 5px;\n    }\n  }\n"])), color.tableCell, color.text, color.border, color.textLight);
...
var AllOptions = function AllOptions() {
  ...
  return /*#__PURE__*/React__default.createElement(Wrapper$7, null, /*#__PURE__*/React__default.createElement(Header$1, null, /*#__PURE__*/React__default.createElement("div", {
    ...
    isLoading: isLoadingRequest,
    center: true
  }, /*#__PURE__*/React__default.createElement("div", null)), allStrikes.length > 0 && /*#__PURE__*/React__default.createElement(React.Fragment, null, /*#__PURE__*/React__default.createElement(Options$1, null, /*#__PURE__*/React__default.createElement("div", {
    className: "button"
